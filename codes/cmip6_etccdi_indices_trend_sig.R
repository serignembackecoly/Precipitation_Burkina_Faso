...
ggsave("figures/final_plot_c.png", plot = final_plot,
       dpi = 400, height = 20, width = 30, bg = "white")

ggsave("figures/final_plot_cdd.png", plot = final_plot_cdd,
       dpi = 400, height = 20, width = 30, bg = "white")

ggsave("figures/final_plot_r10mm.png", plot = final_plot_r10mm,
       dpi = 400, height = 20, width = 30, bg = "white")

ggsave("figures/final_plot_r20mm.png", plot = final_plot_r20mm,
       dpi = 400, height = 20, width = 30, bg = "white")
